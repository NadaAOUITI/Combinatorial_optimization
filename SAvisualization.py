...
if df_ts.empty:
    ...
    plt.tight_layout()
    plt.savefig('SA_optimal_solutions_by_class.png', dpi=300)
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig('SA_optimal_solutions_by_size.png', dpi=300)
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig('SA_optimal_solutions_heatmap.png', dpi=300)
    plt.show()
    ...
    plt.ylabel('Nombre d\'instances', fontsize=14)
    plt.title('Distribution des gaps de SA avec mise en évidence des solutions optimales ', fontsize=16)
    plt.grid(True, linestyle='--', axis='y', alpha=0.7)
    plt.legend()
    plt.tight_layout()
    plt.savefig('SA_gap_distribution_optimal.png', dpi=300)
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig('SA_optimal_solutions_radar.png', dpi=300)
    plt.show()
