...
file_paths = [
    'TS_results_part1.txt',
    'TS_results_part2.txt',
    'TS_results_part3.txt'
]
...
if df_ts.empty:
    ...
    plt.tight_layout()
    plt.savefig('ts_optimal_solutions_by_class.png', dpi=300)
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig('ts_optimal_solutions_by_size.png', dpi=300)
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig('ts_optimal_solutions_heatmap.png', dpi=300)
    plt.show()
    ...
    plt.ylabel('Nombre d\'instances', fontsize=14)
    plt.title('Distribution des gaps de Tabu Search avec mise en évidence des solutions optimales ', fontsize=16)
    plt.grid(True, linestyle='--', axis='y', alpha=0.7)
    plt.legend()
    plt.tight_layout()
    plt.savefig('ts_gap_distribution_optimal.png', dpi=300)
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig('ts_optimal_solutions_radar.png', dpi=300)
    plt.show()
    ...
    print("\n=== RÉSUMÉ DES RÉSULTATS DE TABU SEARCH ===")
